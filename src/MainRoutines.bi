...
Declare Sub GetTeam_SINPUT (T1$, YN$, D)
Declare Sub GetTeam_TRADE (draftYear$, tradeTeam)
Declare Sub GPMIN ()
...
Declare Sub SelectTeam_SINPUT (yearNumber$, numberTeams, selectedIndex)
Declare Sub SelectTeam_TRADE (tradeTeam, numberTeams, yearNumber$)
Declare Sub SINPUT ()
