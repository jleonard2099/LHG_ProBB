...
Declare Sub CalcStatLeadersPro (totalGames, teamName$)
Declare Sub CalcRecordsPro (totalGames, teamName$, finalUpdate$)
...
Declare Sub Hd2HdPro_Report (teamName$, printDest, printFile$)
...
Declare Sub LoadLeaderFiles_League (targetFile$)
...
Declare Sub LeaderStats_Report (printDest, destFile$)
