...
Declare Sub CareerToPrinter (printDest, destFile$, careerPlayers$(), careerFile$)
Declare Sub CareerToScreen (careerPlayers$(), careerFile$)
Declare Sub CARVIEW ()
