...
' --- Not used in HELLO
' --- Focus on scope (Dim vs. Dim Shared)
...
' --- Not used in HELLO
' --- Focus on Dim vs. Dim Shared
Dim Shared pbpDelay As Single, FTF As Single, GP As Single

' --- ???
Dim Shared A(1, 14, 25) As Single
...
' --- ???
Dim Shared AA$(1, 14, 1), B$(3, 5), CM$(1), defenseStyles$(5), FR$(1), FT$(1)
